...
internal sealed class Content<T>(
    ...
    sealed class IterableType<T : Iterable<U>, U : Any?>(
        type: KType,
        ...
        ) : IterableType<List<U>, U>(type, content, isMarkedNullable) {
            override fun deserialize(
                deserializer: Deserializer,
                path: String,
                value: Any,
        ...
        class SetType<U : Any?>(
            ...
            content: Content<U>,
            isMarkedNullable: Boolean,
        ) : IterableType<Set<U>, U>(type, content, isMarkedNullable) {
            override fun deserialize(
                deserializer: Deserializer,
                path: String,
                value: Any,
        ...
        class HashSetType<U>(
            ...
            content: Content<U>,
            isMarkedNullable: Boolean,
        ) : IterableType<HashSet<U>, U>(type, content, isMarkedNullable) {
            override fun deserialize(
                deserializer: Deserializer,
                path: String,
                value: Any,
        ...
        class LinkedHashSetType<U>(
            ...
            content: Content<U>,
            isMarkedNullable: Boolean,
        ) : IterableType<LinkedHashSet<U>, U>(type, content, isMarkedNullable) {
            override fun deserialize(
                deserializer: Deserializer,
                path: String,
                value: Any,
    ...
    class ConfigurationSerializableType(
        ...
        override fun deserialize(
            ...
            path: String,
            value: Any,
        ) = value as? ConfigurationSerializable
    ...
    class EnumType(
        ...
        override fun deserialize(
            ...
            path: String,
            value: Any,
        ) = deserializer.enum(classifier, value)
    ...
    class SectionType<T : Any>(
        type: KType,
        private val constructor: KFunction<T>,
        private val properties: Collection<KProperty1<T, *>>,
        private val contents: Map<KParameter, Content<Any?>>,
    ) : Content<T>(type) {
    ...
    class UseSerializerType<T, Z>(
        type: KType,
        private val serializer: KtConfigSerializer<T, Z>,
        private val content: Content<Any?>,
    ) : Content<Z>(type) {
        override fun deserialize(
            deserializer: Deserializer,
            path: String,
            value: Any,
        ): Z? = serializer.deserialize(content.deserialize(deserializer, path, value) as T)
        ...
        class Keyable<T, Z>(
            ...
            override fun serialize(
                path: String,
                value: Z?,
            ) = useSerializerType.serialize(path, value)
        }
    }
    ...
    class Cache<T>(
        ...
        override fun deserialize(
            ...
            path: String,
            value: Any,
        ) = content().deserialize(deserializer, path, value)

        override fun serialize(
            path: String,
            value: T?,
        ) = content().serialize(path, value)
    }
}
