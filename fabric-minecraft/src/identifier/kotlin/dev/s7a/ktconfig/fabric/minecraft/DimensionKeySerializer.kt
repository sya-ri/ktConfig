...
/**
 * Serializer for converting dimension [ResourceKey] values to and from `namespace:path` identifier strings.
 *
...
object DimensionKeySerializer :
    ...
    override fun decode(value: String): ResourceKey<Level> = ResourceKey.create(Registries.DIMENSION, IdentifierSerializer.decode(value))

    override fun encode(value: ResourceKey<Level>) = value.identifier().toString()
}
